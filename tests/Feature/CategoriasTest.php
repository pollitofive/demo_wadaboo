...
class CategoriasTest extends TestCase
{
    ...
    /** @test */
    function test_an_user_can_see_the_page_procesosxcategorias()
    {
        ...
        $response = $this->actingAs($user)
            ->get('/procesos/categoria/agricultura');

        $response->assertSee('Agricultura');
    ...
    /** @test */
    function test_an_user_can_see_procesosxcategorias_in_the_page()
    {
        $this->markTestIncomplete();
        $this->withoutExceptionHandling();
        $this->seed('CategoriasSeeder');
        ...
        $response->assertSee($proceso_1->fecha_inicio);
        ...
        $response->assertSee($proceso_2->fecha_inicio);
